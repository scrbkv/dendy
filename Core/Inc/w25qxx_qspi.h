...
uint8_t W25qxx_PageProgram(const uint8_t *pData, uint32_t WriteAddr, uint32_t Size);
uint8_t W25qxx_Read(uint8_t *pData, uint32_t ReadAddr, uint32_t Size);
void W25qxx_WriteNoCheck(const uint8_t *pBuffer,uint32_t WriteAddr,uint32_t NumByteToWrite);
